...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['teacher'])) {
        ...
        header("Location: teacher_course_info.php?firstName=$selectedFirstName&lastName=$selectedLastName&role=$selectedRole");
        exit();
    } else {
            ...
            <?php
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<td><input type="radio" name="teacher" value="' . $row['firstName'] . ' ' . $row['lastname'] . '"></td>';
                        echo '</tr>';
                    }
                    echo '</table>';
                } else {
